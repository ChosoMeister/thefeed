...
- **آخرین انتشار** — باینری سرور و کلاینت برای همه پلتفرم‌ها به علاوهٔ APK اندروید. هر کدوم از این دو آینه که در دسترس بود استفاده کنید: [GitLab](https://gitlab.com/sartoopjj/thefeed/-/releases) / [GitHub](https://github.com/sartoopjj/thefeed/releases/latest).
...
# آینهٔ GitLab (در صورتی که اکانت GitHub موقتاً در دسترس نباشه)
...
اسکریپت نصب می‌تونه از هر کدوم از آینه‌های GitHub یا GitLab باینری رو دانلود کنه.
